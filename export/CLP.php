...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        //$this->Cell(25, 1, 'Laporan Hasil Analisa Data Mining Apriori - 212 Mart Bandar Lampung', '', 0, 'C', 1); //TBLR (untuk garis)=> B = Bottom,
        // L = Left, R = Right
...
$pdf->Cell(28, 1, 'Laporan Hasil Analisa Data Mining Apriori - 212 Mart Bandar Lampung', 'LRTB', 0, 'C'); //TBLR (untuk garis)=> B = Bottom,
$pdf->Ln();
$pdf->Ln();
